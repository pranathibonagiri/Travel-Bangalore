...
class IHULViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell1 = tableView.dequeueReusableCell(withIdentifier: "UHLcell") as! UHLITableViewCell
        cell1.title.text = array1[indexPath.row]
        cell1.info.text = array2[indexPath.row]
        return cell1
    }
